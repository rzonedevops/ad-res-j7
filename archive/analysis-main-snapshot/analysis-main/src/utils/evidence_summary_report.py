...
def generate_evidence_summary_report():
    ...
    if evidence_report["critical_missing"]:
        recommendations.append(
            ...
            "critical evidence items are missing and require immediate attention."
        )
    ...
    if evidence_report["summary"]["evidence_gap"] > 5:
        recommendations.append(
            ...
            "evidence completion, additional investigation is required."
        )
    ...
    if high_impact_agents:
        recommendations.append(
            ...
            "scores and warrant detailed investigation."
        )
    ...
    report_lines.extend(
        [
            ...
            "item evidence gap to achieve comprehensive case coverage.",
            "",
            "---",
            "",
