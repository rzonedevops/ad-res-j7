# Phase 1 Critical Evidence - Chronological Narrative with AD References
...
### Task #2834: Gather Responsible Person documentation for 37 jurisdictions
...
### Task #2835: Obtain regulatory risk analysis documentation (JF-RP2)
...
### Task #2836: Collect director loan account statements for all 3 directors
...
### Task #2837: Document Peter's own withdrawals with minimum 4 examples (JF-PA series)
...
### Task #2838: Obtain R500K payment bank statement dated 16 July 2025 (JF-BS1)
...
### Task #2839: Create comparison document highlighting all changes between founding and answering affidavits
...
### Task #2840: Obtain Daniel's witness statement regarding "Has anything changed?"
...
- **JF-RP1:** `jax-dan-response/evidence-attachments/JF-RP1_RESPONSIBLE_PERSON_DESIGNATION_DOCUMENTATION.md`
- **JF-RP2:** `jax-dan-response/evidence-attachments/JF-RP2_REGULATORY_RISK_ANALYSIS.md`

### Director Loan Accounts

- **JF-DLA1:** `jax-dan-response/evidence-attachments/JF-DLA1_PETER_FAUCITT_DIRECTOR_LOAN_ACCOUNT.md`
- **JF-DLA2:** `jax-dan-response/evidence-attachments/JF-DLA2_JACQUELINE_FAUCITT_DIRECTOR_LOAN_ACCOUNT.md`
- **JF-DLA3:** `jax-dan-response/evidence-attachments/JF-DLA3_DANIEL_FAUCITT_DIRECTOR_LOAN_ACCOUNT.md`

### Peter's Withdrawals

- **JF-PA1:** `jax-dan-response/evidence-attachments/JF-PA1_PETER_WITHDRAWAL_15MAR2025.md`
- **JF-PA2:** `jax-dan-response/evidence-attachments/JF-PA2_PETER_WITHDRAWAL_20JUL2025.md`
- **JF-PA3:** `jax-dan-response/evidence-attachments/JF-PA3_PETER_WITHDRAWAL_12JAN2023.md`
- **JF-PA4:** `jax-dan-response/evidence-attachments/JF-PA4_PETER_WITHDRAWAL_15FEB2023.md`

### Bank Statement

- **JF-BS1:** `jax-dan-response/evidence-attachments/JF-BS1_R500K_PAYMENT_BANK_STATEMENT.md`

### Witness Statements

- **JF-DWS1:** `jax-dan-response/evidence-attachments/DANIEL_FAUCITT_WITNESS_STATEMENT.md`
