# SAICA Professional Misconduct Complaint: Daniel Jacobus Bantjies
...
This complaint details severe and sustained professional misconduct by Daniel Jacobus Bantjies (SAICA 00105928) in his capacity as the external accountant for the RegimA group of entities. Documentary evidence (emails from his own account) proves that Bantjies systematically violated the SAICA Code of Professional Conduct by:
1. Signing off on financial statements he knew contained "huge gaps building up over many years."
2. Accepting instructions from a bookkeeper to make backdated journal entries.
3. Initiating "two big inter company invoices" that the bookkeeper could not explain, which were subsequently flagged by SARS.
4. Drafting the response to SARS to explain the very transactions he initiated, constituting a severe conflict of interest.

*Note: Bantjies' current SAICA membership status must be verified via the SAICA public register. If his membership has lapsed, we request this complaint be forwarded to the Independent Regulatory Board for Auditors (IRBA) or the relevant professional body where he currently holds registration.*

## 2. Violations of the SAICA Code of Professional Conduct

### 2.1 Breach of Integrity (Section 111)
...
- **Evidence:** On 17 August 2021, Bantjies accepted instructions from the company bookkeeper (Rynette Farrar) to make specific journal entries dated 01/08/2020 (over a year backdated). This represents a complete inversion of financial controls, where the external accountant acts merely as a data-entry clerk for the bookkeeper. [3]

### 2.3 Breach of Objectivity and Conflict of Interest (Section 112 & 210)
A chartered accountant must not allow bias, conflict of interest, or undue influence of others to override professional or business judgments.
- **Evidence:** In February 2025, Bantjies initiated "two big inter company invoices" that were so anomalous they were flagged by SARS. The bookkeeper explicitly stated: *"The two big invoices were done on your request, for which I have no answer."* [4]
...
|-----------|-------------|-------------------------|
| **[1]** | Email: Bantjes to Rynette (7 Apr 2025) | Admission of "huge gaps" building up over years (Integrity breach). |
| **[2]** | Email: Rynette to Bantjes (4 Apr 2025) | Proposal to "permanently remove" the discrepancy (Integrity breach). |
| **[3]** | Email: Rynette to Bantjes (17 Aug 2021) | Acceptance of backdated journal entry instructions (Competence breach). |
...
The documentary evidence—consisting of Bantjies' own emails—demonstrates a pattern of deliberate financial manipulation and a complete disregard for professional standards. We request that SAICA:
1. Institute immediate disciplinary proceedings against Daniel Jacobus Bantjies.
2. Suspend his membership pending the outcome of the investigation to protect the public and the integrity of the profession.
